 ...
 *
 * radix-ui's popper (used by `components/ui/tooltip.tsx`) measures its
 * content with one as soon as a tooltip opens. Current happy-dom provides it,
 * but an older shim (or a future swap) may not — and a missing constructor
